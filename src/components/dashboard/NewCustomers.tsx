...
const NewCustomers = ({
  ...
  return (
    <div className="flex justify-between gap-4 border-b border-b-gray-50 pb-5">
      <div className="flex gap-3">
        ...
        <div className="space-y-0.5">
          ...
          <p className="text-xs text-gray-300">{customerID}</p>
        </div>
      </div>
      <div className="flex justify-end items-end">
        <p className="text-xs text-gray-300">{timeAgo(signUpTime)}</p>
      </div>
    </div>
  );
};
